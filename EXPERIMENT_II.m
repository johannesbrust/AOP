...
m           = 150; % Number of columns in X and Y // 4, 300
...
if issmall == 1
    ...
    data_tbl3   = [times_all(:,1:2),errs_all(:,1),errs_all(:,5),...
                    errs_all(:,2),errs_all(:,6)];
                
    data_tbl4   = [times_all(:,3:4),errs_all(:,3),errs_all(:,7),...
                    errs_all(:,4),errs_all(:,8)];
    
    save('EXPERIMENT_II_S.mat','times_all','errs_all');
    ...
    data_tbl5   = [times_all,errs_all(:,1),errs_all(:,3),errs_all(:,2),...
                    errs_all(:,4)];
    
    save('EXPERIMENT_II_L.mat','times_all','errs_all');
